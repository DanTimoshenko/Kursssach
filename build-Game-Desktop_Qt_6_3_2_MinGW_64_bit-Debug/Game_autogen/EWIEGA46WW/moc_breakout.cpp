...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Breakout_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Breakout_t qt_meta_stringdata_Breakout = {
    {
        QT_MOC_LITERAL(0, 8)   // "Breakout"
    },
    "Breakout"
};
...
const QMetaObject Breakout::staticMetaObject = { {
    ...
    qt_meta_stringdata_Breakout.offsetsAndSizes,
    qt_meta_data_Breakout,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Breakout_t
, QtPrivate::TypeAndForceComplete<Breakout, std::true_type>
